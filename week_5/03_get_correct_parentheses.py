...
def is_correct_aprentheses(string):
    stack = []
    for s in string:
        if s == '(':
            stack.append(s)
...
def change_to_correct_parentheses(string):
    ...
    if is_correct_aprentheses(u):
        return u + change_to_correct_parentheses(v)
    else:
        return '(' + change_to_correct_parentheses(v) + ')' + reverse_parentheses(u)


def get_correct_parentheses(balanced_parentheses_string):
    if is_correct_aprentheses(balanced_parentheses_string):
